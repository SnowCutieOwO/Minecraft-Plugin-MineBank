...
public class CheckConfigDefaults {
    ...
    public static void checkConfigDefaults(MineBank plugin) {
        ...
        defaultConfigValues.put("bank.level.2", "10000;5000");
        defaultConfigValues.put("bank.level.3", "20000;10000");
        defaultConfigValues.put("bank.level.4", "50000;25000");
        defaultConfigValues.put("bank.level.5", "100000;50000");

        defaultConfigValues.put("bank.profit.min-amount-to-win", 100);
        defaultConfigValues.put("bank.profit.keep-in-bank", 1);
        defaultConfigValues.put("bank.profit.interval", 300);

        defaultConfigValues.put("bank.interests.min-amount-to-lose", 500);
        defaultConfigValues.put("bank.interests.withdraw", 2);
        ...
        defaultMessageValues.put("messages.help-bank", new String[]{
                ...
                "&e/bank add max &7- Deposit the max balance to your bank level",
                "&e/bank take max &7- Withdraw the max balance you can withdraw with interests",
                "&e/bank set <player> bal max &7- Sets player balance to the max of its level",
                "&e/bank set <player> level max &7- Sets player balance to the max bank level",
                "&e/bank set <player> bal <amount> &7- Set player balance",
                "&e/bank set <player> level <level> &7- Set player level to <level>",
                "&e/bank set <player> level <level> true &7- Set player level, and set balance to max of the level",
                "&e/bank set <player> level <level> false &7- Set player level, and modify balance if is over max of the level",
                ...
                "&e/bank level <player> &7- Check your bank level",
        ...
        defaultMessageValues.put("messages.permissions", new String[]{
                ...
                "&eminebank.admin &7- Allow to use (admin) commands",
        ...
        defaultMessageValues.put("config.bank-disabled", "%plugin% &cThe bank function is currently disabled.");
        defaultMessageValues.put("config.update-checker", "%plugin% &bNew version available &e(&f%latestversion%&e)&b. Download it here: &7%link%");
        ...
        defaultMessageValues.put("bank.usage.set", "%plugin% &eUsage: /bank set <player> <bal/level> <amount> [true/false]");
        defaultMessageValues.put("bank.usage.top", "%plugin% &eUsage: /bank top");
        defaultMessageValues.put("bank.usage.bal", "%plugin% &eUsage: /bank bal [player]");
        defaultMessageValues.put("bank.usage.max", "%plugin% &eUsage: /bank max <bal/level>");
        defaultMessageValues.put("bank.usage.level", "%plugin% &eUsage: /bank level [player]");
        ...
        defaultMessageValues.put("bank.set.depositFailure", "%plugin% &cThe amount must be positive and integer number.");
        ...
        defaultMessageValues.put("bank.level.yourLevel", "%plugin% &eYour bank level is: &a%level%");
        defaultMessageValues.put("bank.level.playerLevel", "%plugin% &e%player%`s balance is: &a$%level%");
        ...
        defaultMessageValues.put("bank.profit.min-storage", "%plugin% &cYou need al least $%amount% in the bank to start earning benefits.");
